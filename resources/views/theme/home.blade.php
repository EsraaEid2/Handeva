            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="about-image-wrap">
                        <a href="about.html"><img src="{{ asset('assets') }}/img/about-img.png" alt="About Us"
                                class="img-fluid" /></a>
                    </div>
                    ...
                    <div class="about-content-wrap ml-0 ml-lg-5 mt-5 mt-lg-0">
                        ...
                        <div class="about-text">
                            ...
                            <p>Typi noni habented claritatem insitamed ested usused legentis in iis qui facit eorum
                                claritatem. Investigationes demonstraverunt lectores legere me lius quod ii loreem ipsum
                                ius
                        ...
                        <ul class="nav tab-menu-wrap" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="feature-products-tab" data-toggle="tab" href="#feature-products"
                                    role="tab" aria-controls="feature-products-tab" aria-selected="true">Feature
                                    Products</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="products-wrapper">
                                    <div class="products-carousel owl-carousel">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img
                                                        src="{{ asset('assets') }}/img/product-1.jpg" alt="Products"
                                                        class="img-fluid"></a>
                                            </figure>
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img
                                                        src="{{ asset('assets') }}/img/product-2.jpg" alt="Products"
                                                        class="img-fluid"></a>
                                            </figure>
                                ...
                                <div class="products-wrapper">
                                    <div class="products-carousel owl-carousel">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img
                                                        src="{{ asset('assets') }}/img/sale-product-1.jpg"
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img
                                                        src="{{ asset('assets') }}/img/sale-product-2.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
                    ...
                    <div class="large-size-cate">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/women-cat.jpg"
                            ...
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/men-cat.jpg" alt="Men Category"
                                                class="img-fluid" /></a>
                    ...
                    <div class="small-size-cate">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/jewellery-cat.jpg"
                            ...
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/women-cat2.jpg"
                                                alt="Men Category" class="img-fluid" /></a>
                            ...
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/watch-cat.jpg"
                                                alt="Men Category" class="img-fluid" /></a>
                            ...
                            <div class="col-sm-6">
                                <div class="single-cat-item">
                                    <figure class="category-thumb">
                                        <a href="#"><img src="{{ asset('assets') }}/img/suit-cat.jpg" alt="Men Category"
                                                class="img-fluid" /></a>
                ...
                <div class="col-lg-12">
                    <div class="products-wrapper">
                        <div class="new-products-carousel owl-carousel">
                            ...
                            <div class="single-product-item text-center">
                                <figure class="product-thumb">
                                    <a href="single-product.html"><img src="{{ asset('assets') }}/img/new-product-1.jpg"
                                            alt="Products" class="img-fluid"></a>
                                </figure>
                            ...
                            <div class="single-product-item text-center">
                                <figure class="product-thumb">
                                    <a href="single-product.html"><img src="{{ asset('assets') }}/img/new-product-2.jpg"
                                            alt="Products" class="img-fluid"></a>
                                </figure>
                            ...
                            <div class="single-product-item text-center">
                                <figure class="product-thumb">
                                    <a href="single-product.html"><img src="{{ asset('assets') }}/img/new-product-3.jpg"
                                            alt="Products" class="img-fluid"></a>
                                </figure>
                            ...
                            <div class="single-product-item text-center">
                                <figure class="product-thumb">
                                    <a href="single-product.html"><img src="{{ asset('assets') }}/img/new-product-4.jpg"
                                            alt="Products" class="img-fluid"></a>
                                </figure>
