                        ...
                        <div class="col-lg-12">
                            <div class="imgage-gallery-carousel owl-carousel">
                                <div class="gallery-item">
                                    <a href="#"><img src="{{ asset('assets') }}/img/gallery-img-1.jpg"
                                            alt="Gallery" /></a>
                                </div>
                                <div class="gallery-item">
                                    <a href="#"><img src="{{ asset('assets') }}/img/gallery-img-2.jpg"
                                            alt="Gallery" /></a>
                                </div>
                                <div class="gallery-item">
                                    <a href="#"><img src="{{ asset('assets') }}/img/gallery-img-3.jpg"
                                            alt="Gallery" /></a>
                                </div>
                                <div class="gallery-item">
                                    <a href="#"><img src="{{ asset('assets') }}/img/gallery-img-4.jpg"
                                            alt="Gallery" /></a>
                                </div>
                                <div class="gallery-item">
                                    <a href="#"><img src="{{ asset('assets') }}/img/gallery-img-3.jpg"
